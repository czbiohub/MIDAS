...
def rename_markers(iggdb, gdim, outdir, _my_command):
    ...
    # "precursor" marker genes generated by chunyu by running hmmsearch on the 23,790 repgenomes of iggdb
    # "precursor" not in a biological sense but because their names are autogenerated by prokka and do not match the gene naming scheme for IGGdb/midas
these names are to be translated by a smelter build step artisanally handcrafted for this single use
